...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.4.661.dmg";
    hash = "sha256-HNPxj7QZOj5tzuSSQaUp9JvaCi6dpQEy5GY5Xv76QjU=";
  };
  ...
  sourceRoot = "Flow-v1.4.661/Wispr Flow.app";
