...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.4.894.dmg";
    hash = "sha256-d1ukdafhAowfEAVOvBpvx7KYCXQqqO+WnspXp8cH3+0=";
  };
  ...
  sourceRoot = "Flow-v1.4.894/Wispr Flow.app";
