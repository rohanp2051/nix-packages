...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.6.827.dmg";
    hash = "sha256-mRFkLkcOPp7xnZ319+CTvas/28TIY540FBB6wg+E/eU=";
  };
  ...
  sourceRoot = "Flow-v1.6.827/Wispr Flow.app";
