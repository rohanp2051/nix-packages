...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.6.447.dmg";
    hash = "sha256-btlvrWA7gNcxzOFCpjEGKmLE12h6PhQG95992DcznEc=";
  };
  ...
  sourceRoot = "Flow-v1.6.447/Wispr Flow.app";
