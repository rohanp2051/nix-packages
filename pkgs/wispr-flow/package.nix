...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.6.897.dmg";
    hash = "sha256-YsWoLNyTRNzK6FujZ6RzkKK1+mFY2WgiW3Yi3UZE+F0=";
  };
  ...
  sourceRoot = "Flow-v1.6.897/Wispr Flow.app";
