...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.4.752.dmg";
    hash = "sha256-ht/0OmiiPbfol534jqwf/HGiAkZ3rgpwYwsL6Gq7lQ0=";
  };
  ...
  sourceRoot = "Flow-v1.4.752/Wispr Flow.app";
