...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.4.822.dmg";
    hash = "sha256-GsFb11vJ+asTOBCGS0OML0mNtsPPzQl6NU4aQKA8xWQ=";
  };
  ...
  sourceRoot = "Flow-v1.4.822/Wispr Flow.app";
