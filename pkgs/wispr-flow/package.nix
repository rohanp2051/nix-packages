...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.5.67.dmg";
    hash = "sha256-I1QzmCSa1fM/cs+pg2rtkjVHFtSf/dp/B+xucCVlSF8=";
  };
  ...
  sourceRoot = "Flow-v1.5.67/Wispr Flow.app";
