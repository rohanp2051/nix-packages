...
stdenvNoCC.mkDerivation {
  ...
  src = fetchurl {
    url = "https://dl.wisprflow.com/wispr-flow/darwin/arm64/dmgs/Flow-v1.4.549.dmg";
    hash = "sha256-zyatHXmp2bET/nZKNstkQGel7X6u/TxvBlUOreXEcVI=";
  };
  ...
  sourceRoot = "Flow-v1.4.549/Wispr Flow.app";
